...
public class ExcelExportService {
    ...
    private void addSummarySheet(Workbook workbook, List<ImpayeDto> impayes) {
        ...
        sheet.createRow(2).createCell(0).setCellValue("Total enregistrements:");
        ...
        long nbImpayes = impayes.stream()
            ...
            .count();
        long nbRegularises = impayes.stream()
            .filter(i -> i.getStatut() != null && "REGULARISE".equals(i.getStatut().name()))
            .count();
        long nbLitiges = impayes.stream()
            .filter(i -> i.getStatut() != null && "LITIGE".equals(i.getStatut().name()))
            .count();
        ...
        sheet.createRow(5).createCell(0).setCellValue("En litige:");
        sheet.getRow(5).createCell(1).setCellValue(nbLitiges);
